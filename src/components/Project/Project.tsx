          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Takshak-Shetty/Hostel_Allocation_System" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
                <a href="https://hostel-allocation-system-tau.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Live Demo" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Smart Hostel Allocation System</h3>
              <p>
                A production-ready full-stack web app for automated hostel room allocation and SLA-based complaint management. Features JWT-secured student portal, real-time room allocation, complaint lifecycle tracking, and an admin dashboard with live occupancy stats and auto complaint escalation.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Takshak-Shetty/EduManage" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="GitHub" />
                </a>
                <a href="https://edu-manage-nu.vercel.app" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Live Site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>EduManage – Smart Academic Management Platform</h3>
              <p>
                MERN stack application for managing student records with role-based access control and secure authentication.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                My personal portfolio website showcasing my skills, projects, and contact details. Built with React and TypeScript using Styled Components.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Takshak-Shetty/rsa-kyber512-performance-benchmark" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>RSA vs Kyber512 Performance Benchmark</h3>
              <p>
                Benchmarked RSA and Kyber512 post-quantum cryptography by comparing key generation, encryption, decryption, key size, and memory usage, with automated performance analysis and visualization.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/Takshak-Shetty/CyberRange-Gamified-Cybersecurity-Training-Platform"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="GitHub" />
            ...
            <div className="body">
              <h3>CyberRange – Gamified Cybersecurity Training Platform</h3>
              <p>
                A Counter-Strike-inspired cyber battle simulator featuring Red Team
                attacks, Blue Team defenses, real-time scoring, Wazuh SIEM integration,
                and an interactive HUD dashboard.
              </p>
            </div>
